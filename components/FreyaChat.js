...
const CHAT_DATA = {
    ...
    quickReplies: [
      {
        ...
        a: 'নীচের + বোতাম চাপুন, তারপর আবেদনকারীর সব তথ্য পূরণ করুন। মূল্যায়ন শুরু করতে ২৫টি প্রশ্নের উত্তর দিন। সাধারণত ১৫-২০ মিনিট লাগে।',
      },
      {
        q: 'লাল চিহ্ন মানে কী?',
      ...
      },
      {
        ...
        a: '২৫টি প্রশ্নের উত্তর থেকে ৭টি মানসিক মাত্রায় স্কোর হিসাব হয়। উত্তরের গতি, সামাজিক কাম্যতা এবং সামঞ্জস্য-পরীক্ষা দিয়ে মিথ্যা-পতাকা নির্ধারণ হয়। চূড়ান্ত স্কোর ০–১০০০।',
      },
      {
        q: 'আজকের পরিসংখ্যান কী বলছে?',
        a: 'এই মাসে ১৪৭টি মূল্যায়নের মধ্যে ৭১% অনুমোদিত হয়েছে। গড় স্কোর ৬৮৪। ১৯টি মিথ্যা-পতাকার মধ্যে ৭টি পুনর্বিবেচনার প্রয়োজন।',
      },
    ],
  },
  intake: {
  ...
  result: {
    tip: {
      ...
      en: 'Even with a good score, ask me why if you see red flags.',
    },
    quickReplies: [
      {
        q: 'লাল পতাকা থাকলে কী করব?',
        a: 'মিথ্যা-পতাকা থাকলে প্রথমে Flags ট্যাবে বিস্তারিত দেখুন। সামাজিক কাম্যতা পতাকা থাকলে অন্যভাবে প্রশ্ন করুন। রেটিং C/D হলে প্রশাখা ব্যবস্থাপককে অবহিত করুন।',
      },
      {
