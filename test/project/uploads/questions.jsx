// Psychometric question bank for PKSF PO loan officers.
// 25 questions across 7 dimensions. Mixed formats. Anti-lying pairs + social-desirability traps.
// bn = Bangla, en = English sub-label for manager review.
//
// Lie-detection mechanics:
//   consistencyPair: two questions probe same construct differently
//   socialDesirability: flags "too-perfect" answers
//   expectedResponseMs: average answer time — anomalies flagged
//   crossCheck: validates against intake data

const DIMENSIONS = [
  { id: 'entrepreneurial', bn: 'উদ্যোগী মানসিকতা', en: 'Entrepreneurial Spirit', color: '#2EC4B6', icon: '◆' },
  { id: 'risk',            bn: 'ঝুঁকি নেওয়ার ক্ষমতা', en: 'Risk Appetite',         color: '#B5874F', icon: '◈' },
  { id: 'financial',       bn: 'আর্থিক শৃঙ্খলা',      en: 'Financial Discipline',  color: '#16A34A', icon: '◉' },
  { id: 'social',          bn: 'সামাজিক পুঁজি',       en: 'Social Capital',        color: '#7B2D8B', icon: '◎' },
  { id: 'business',        bn: 'ব্যবসায়িক জ্ঞান',    en: 'Business Knowledge',    color: '#0284C7', icon: '◍' },
  { id: 'resilience',      bn: 'সহনশীলতা',            en: 'Resilience',            color: '#D97706', icon: '◐' },
  { id: 'motivation',      bn: 'অনুপ্রেরণা',          en: 'Motivation',            color: '#E04F4F', icon: '◑' },
];
...
const QUESTIONS = [
  ...
  },
  {
    ...
    bn: 'নতুন কিছু চেষ্টা করতে আমি সবসময় প্রথম হই।',
    en: "I'm always first to try new things.",
    scale: { min: 1, max: 5, minBn: 'একমত নই', maxBn: 'সম্পূর্ণ একমত', minEn: 'Disagree', maxEn: 'Agree' },
    socialDesirability: true, // too-high flagged
    expectedMs: 3500,
  },
  {
    ...
    options: [
      ...
      { bn: '২টি',          en: '2',        score: 3 },
      { bn: '৩টি',          en: '3',        score: 5 },
      { bn: '৪ বা তার বেশি', en: '4 or more', score: 4 }, // too many can mean instability
    ],
    crossCheck: 'occupation',
    expectedMs: 4500,
  },
  {
    id: 'q4', dim: 'entrepreneurial', type: 'forced',
    bn: 'কোনটি আপনার জন্য বেশি জরুরি?',
    en: 'Which matters more to you?',
    options: [
  ...
  // ── RISK APPETITE (3) ─────────────────────────────────────
  {
    ...
    options: [
      { bn: 'রাজি হব, সুযোগ',                 en: 'Accept — opportunity',   score: 1 }, // red flag
  ...
  },
  {
    ...
    bn: 'সুযোগ পেলে আমি নিশ্চয়তা ছাড়াও ঝুঁকি নিতে রাজি।',
    en: 'I take risks without full guarantees when opportunities arise.',
    scale: { min: 1, max: 5, minBn: 'কখনোই না', maxBn: 'সবসময়', minEn: 'Never', maxEn: 'Always' },
    consistencyPair: 'q4', // high risk appetite should align with growth-preference in q4
    expectedMs: 3500,
  },
  {
  ...
  },
  {
    ...
    bn: 'প্রতি মাসে আমি আয়ের কিছু অংশ সঞ্চয় করি।',
    en: 'I save part of my income every month.',
  ...
  },
  {
    ...
    consistencyPair: 'q9', // claims saving but also late payments = flag
    expectedMs: 4000,
  },
  {
  ...
  // ── SOCIAL CAPITAL (3) ────────────────────────────────────
  {
    ...
    bn: 'বিপদে পড়লে আমার গ্রামে অন্তত ৩ জন সাহায্য করবেন।',
    en: 'In trouble, at least 3 people in my village will help me.',
  ...
  },
  {
    ...
    options: [
      ...
      { bn: 'সবাই',           en: 'All',         score: 4 }, // may be inflated
    ],
    consistencyPair: 'q12',
    expectedMs: 4500,
  },
  ...
  // ── BUSINESS KNOWLEDGE (4) ────────────────────────────────
  {
    ...
    options: [
      { bn: '১৫,০০০',  en: '15,000', score: 5 }, // correct
  ...
  },
  {
    ...
    en: 'Who sets the price of your product?',
    options: [
  ...
  },
  {
    ...
    bn: 'আপনি কীভাবে জানেন কোন পণ্যটি বেশি বিক্রি হচ্ছে?',
    en: 'How do you know which product sells most?',
    options: [
  ...
  },
  {
    ...
    bn: 'ব্যবসায় মূলধন (পুঁজি) আর মুনাফার (লাভ) পার্থক্য কী?',
    en: 'Difference between capital and profit?',
    options: [
  ...
  // ── RESILIENCE (3) ───────────────────────────────────────
  {
    ...
    options: [
      { bn: 'কোনো বড় ধাক্কা হয়নি',       en: 'No major setback',       score: 3 }, // could mean stable OR hiding
    ...
    socialDesirability: true, // "no setback" often not believable
    expectedMs: 5000,
  },
  {
    id: 'q20', dim: 'resilience', type: 'scenario',
    bn: 'সেই ধাক্কা থেকে কত দিনে আপনি ঘুরে দাঁড়িয়েছেন?',
    en: 'How long did it take to recover?',
    options: [
  ...
  },
  {
    ...
    bn: 'কঠিন সময়েও আমি হাল ছাড়ি না।',
    en: "I don't give up in hard times.",
    scale: { min: 1, max: 5, minBn: 'একমত নই', maxBn: 'সম্পূর্ণ একমত', minEn: 'Disagree', maxEn: 'Agree' },
    socialDesirability: true,
    expectedMs: 3000,
  },
  ...
  },
  {
    ...
    bn: 'আমি পরিবারের জন্য কঠিন পরিশ্রম করতে রাজি।',
    en: 'I am willing to work hard for my family.',
    scale: { min: 1, max: 5, minBn: 'একমত নই', maxBn: 'সম্পূর্ণ একমত', minEn: 'Disagree', maxEn: 'Agree' },
    socialDesirability: true, // almost everyone says max — check timing
    expectedMs: 2500,
  },
  {
    id: 'q25', dim: 'motivation', type: 'scenario',
    bn: 'আপনি সপ্তাহে কত ঘণ্টা ব্যবসা/কাজে দেন?',
    en: 'Hours per week you work on your business?',
    options: [
