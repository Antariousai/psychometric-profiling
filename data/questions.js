export const QUESTIONS = [
  ...
  { id: 'q17', dim: 'business', type: 'scenario',
    bn: 'আপনি কীভাবে জানেন কোন পণ্যটি বেশি বিক্রি হচ্ছে?', en: 'How do you know which product sells the most?',
    options: [
      { bn: 'কখনো না', en: 'Never', score: 1 },
      { bn: 'ইচ্ছা হলে', en: 'When I feel like it', score: 2 },
      { bn: 'নিরপেক্ষ', en: 'Neutral', score: 3 },
      { bn: 'চেষ্টা করি', en: 'I try to', score: 4 },
      { bn: 'প্রতি মাসে', en: 'Every month', score: 5 },
    ], expectedMs: 4500 },
